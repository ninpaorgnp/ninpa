<template>
    <footer
        class="max-w-7xl w-full  py-10 px-6 sm:px-6 lg:px-8 mx-auto mt-8 border-t-4 border-primary-400 bg-primary-800 text-gray-50">
        <!-- Grid -->
        <div class="grid grid-cols-2 md:grid-cols-4  gap-6 mb-10">
            <div>
                <a class="flex-none font-semibold text-xl focus:outline-none focus:opacity-80" href="#"
                    aria-label="Brand"><img src="/logo100.webp" alt="NINPA" class="invert brightness-0" />
                </a>
            ...
            <div>
                <h4 class="text-xs font-semibold text-gray-50 uppercase">Quick Links</h4>
            ...
            <div class="mt-4 lg:mt-0">
                <h4 class="text-xs font-semibold text-gray-100 uppercase">Contact Info</h4>

                <div class="mt-3 grid space-y-3 text-sm">
                    <p>Sun-Fri (9:00AM-5PM)</p>
                    <p>
                        G.P.O. Box 7238 <br />
                        Naya Baneshwor, Kathmandu Nepal<br />
                        Phone: <a href="tel:97714115687">977-1-4115687</a>,
                        <a href="tel:97714107615">977-1-4107615</a><br />
                        Fax: 977-1-4115590<br />
                        Email: <a href="mailto:ninpanepal@gmail.com" class="text-yellow-300">ninpanepal@gmail.com</a>
                    </p>
        ...
        <div class="pt-5 mt-5 border-t border-blue-500">
