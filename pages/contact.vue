<template>
    ...
    <Head>
        <Title>Contact Us | The Nepal Indigenous Nationalities Preservation Association</Title>
        <Meta name="description" content="Please feel free to contact us, if you have any question about our work." />
    </Head>
    <div class="max-w-7xl mx-auto">
        <div class="w-full py-6 text-center mx-auto bg-primary-600">
            <h2 class="font-medium text-white text-2xl sm:text-4xl">
                Contacts
            </h2>
        </div>
        <div class="my-16 px-6 lg:px-0">
            <div class="grid grid-cols-1 lg:grid-cols-2 lg:items-center gap-6 md:gap-8 lg:gap-12">
                <div class="aspect-w-16 aspect-h-6 lg:aspect-h-14 overflow-hidden bg-gray-100 rounded-2xl">
                    <img class="group-hover:scale-105 group-focus:scale-105 transition-transform duration-500 ease-in-out object-cover rounded-2xl"
                        src="/contact.webp" alt="Contacts Image">
                </div>
                <!-- End Col -->
